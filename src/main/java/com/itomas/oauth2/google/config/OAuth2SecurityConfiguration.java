package com.itomas.oauth2.google.config;
...
class OAuth2SecurityConfiguration {
    ...
    public OAuth2ProtectedResourceDetails googleResource() {
        ...
        details.setPreEstablishedRedirectUri(env.getProperty("google.preestablished.redirect.url")+env.getProperty("google.preestablished.redirect.url.base"));
